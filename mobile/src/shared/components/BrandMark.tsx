...
export function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    <View style={styles.row}>
      ...
      <View style={styles.copy}><Text numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.8} style={[styles.name, compact && styles.nameCompact]}>Vocivo</Text>{!compact && <Text style={styles.slogan}>Connect. Talk. Anywhere.</Text>}</View>
    </View>
  );
}
