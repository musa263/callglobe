...
import { createRegistrationKeeper, reconnectDelayMs } from './sipRegistrationKeeper.js';
...
function harness() {
  ...
  return {
    ...
    timers,
    fire,
    failReconnects: (times) => { reconnectFails = times; },
    failRegister: (error) => { registerFails = error; },
  };
}
